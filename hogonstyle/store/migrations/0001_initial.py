# Generated by Django 3.2.5 on 2021-09-22 17:49
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_code', models.CharField(default='bSdLKs4m', editable=False, max_length=8, verbose_name='کد مشتری')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('link', models.CharField(blank=True, max_length=100, verbose_name='لینک')),
                ('image', models.ImageField(help_text='Size: 1920x570', upload_to='', verbose_name='عکس')),
                ('is_active', models.BooleanField(default=True, verbose_name='فعال بودن')),
                ('settgs', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='store.sitesettings', verbose_name='تنظیمات')),
            ],
            options={
                'verbose_name': 'اسلاید',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('code', models.CharField(default='jteQJyyu', editable=False, max_length=6, verbose_name='کد سفارش')),
